...
public class LimeLight extends SubsystemBase {
  ...
  private void DistanceFinder(boolean longRange) {
  ...
  public void strobe(){
    ...
    if(Robot.m_oi.isButtonReleased(Constants.XBOX_BB, false)){
      strobeMode=false;
      NetworkTableInstance.getDefault().getTable("limelight").getEntry("ledMode").setNumber(0);
  ...
  public void periodic() {
    if(Robot.m_oi.isButtonPressed(Constants.XBOX_BB, false)){
      strobeMode=true;
    }
    ...
    SmartDashboard.putNumber("cheese", 24);
